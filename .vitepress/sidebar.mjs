export default {
    '/Ku/Python/': [
        {
            ...
            items: [
                ...
                { text: '条件语句', link: '/Ku/Python/basic/if.md' },
                { text: '循环语句', link: '/Ku/Python/basic/loop.md' },
                { text: '函数与模块', link: '/Ku/Python/basic/function.md' },
                { text: '常用内置函数', link: '/Ku/Python/basic/builtin.md' },
    ...
    '/Other/markdown/': [
        ...
        },
        {
            ...
            collapsed: true,
            items: [
                { text: '写作与排版技巧', link: '/Other/markdown/practice/writing.md' },
                { text: '项目文档编写', link: '/Other/markdown/practice/doc.md' },
                { text: '博客与简历实战', link: '/Other/markdown/practice/blog-resume.md' },
                { text: '常见问题与解决方案', link: '/Other/markdown/practice/faq.md' }
            ]
        }
    ],
    '/Smoking/': [
